...
const addressData = [
  {
    icon: faLocationDot,
    title: "Address",
    description: "Mangalore-575014, Karnataka, India",
  },
  {
    icon: faEnvelope,
    title: "My Email",
    description: "shripathibhat86@gmail.com",
  },
  {
    icon: faPhone,
    title: "Call Me Now",
    description: "+91 87225 70265",
  },
];
          ...
          <div>
            <div>
              ...
              <p className="text-[12px] xs:text-[14px] sm:text-lg md:text-lg max-lg:text-center pt-4 font-normal text-soft-dark">
                I am open to discussing consulting opportunities, IT strategy advisory roles, and exciting projects. Let's connect!
              </p>
            </div>
